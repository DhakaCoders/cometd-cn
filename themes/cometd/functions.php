...
Constants->>
*/
defined('THEME_NAME') or define('THEME_NAME', 'cometd');
...
if( !function_exists('cbv_theme_setup') ){
    ...
    function cbv_theme_setup(){
      ...
      load_theme_textdomain( 'cometd', get_template_directory() . '/languages' );
        ...
        register_nav_menus( array(
            ...
            'cbv_ft_menu' => __( 'Footer Menu', 'lpw' )
        ) );
...
if( function_exists('acf_add_options_page') ) { 
    ...
    acf_add_options_page(array(
        'page_title'    => __('Options', 'cometd'),
        'menu_title'    => __('Options', 'cometd'),
